...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="{{url('backend/assets/favicon/apple-icon-60x60.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{url('backend/assets/favicon/apple-icon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{url('backend/assets/favicon/apple-icon-76x76.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{url('backend/assets/favicon/apple-icon-114x114.png')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{url('backend/assets/favicon/apple-icon-120x120.png')}}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{url('backend/assets/favicon/apple-icon-144x144.png')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{url('backend/assets/favicon/apple-icon-152x152.png')}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{url('backend/assets/favicon/apple-icon-180x180.png')}}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{url('backend/assets/favicon/android-icon-192x192.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('backend/assets/favicon/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{url('backend/assets/favicon/favicon-96x96.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('backend/assets/favicon/favicon-16x16.png')}}">
    <link rel="manifest" href="{{url('backend/assets/favicon/manifest.json')}}">
    ...
    <link href="{{url('backend/css/examples.css')}}" rel="stylesheet">
  ...
  <body>
    ...
    <script src="{{url('backend/vendors/@coreui/coreui/js/coreui.bundle.min.js')}}"></script>
    <script src="{{url('backend/vendors/simplebar/js/simplebar.min.js')}}"></script>
    <!-- Plugins and scripts required by this view-->
    <script src="{{url('backend/vendors/chart.js/js/chart.min.js')}}"></script>
    <script src="{{url('backend/vendors/@coreui/chartjs/js/coreui-chartjs.js')}}"></script>
    <script src="{{url('backend/vendors/@coreui/utils/js/coreui-utils.js')}}"></script>
